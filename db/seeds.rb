...
#   Character.create(name: 'Luke', movie: movies.first)
	...
	Permit.find_or_create_by(name: "Votar positivo", score: 15, descripcion: "Votar de forma positiva en preguntas, respuests y comentarios", user_id: 1)
	Permit.find_or_create_by(name: "Comentar", score: 20, descripcion: "Comentar en preguntas y respuestas", user_id: 1)
	Permit.find_or_create_by(name: "Votar negativo", score: 100, descripcion: "Votar de forma negativa en preguntas, respuestas y comentarios", user_id: 1)
	Permit.find_or_create_by(name: "Administrar categorias", score: 300, descripcion: "Crear, editar y eliminar categoías", user_id: 1)
	Permit.find_or_create_by(name: "Administrar facultades", score: 500, descripcion: "Crear, editar y eliminar facultades", user_id: 1)
